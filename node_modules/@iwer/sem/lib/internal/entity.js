...
import { Bounded2DComponent } from '../native/components/bounded2d.js';
import { Bounded3DComponent } from '../native/components/bounded3d.js';
import { LocatableComponent } from '../native/components/locatable.js';
import { SemanticLabelJSON } from '../native/description.js';
import { SemanticLabelsComponent } from '../native/components/semanticlabels.js';
import { SpatialEntityComponentType } from '../native/components/component.js';
import { TriangleMeshComponent } from '../native/components/trianglemesh.js';
		...
		if (!this._nativeEntity) {
			...
			const semanticLabel =
				WebXRSemanticLabelMap[
					this.getComponent(SpatialEntityComponentType.SemanticLabels)
						.semanticLabel
				];
