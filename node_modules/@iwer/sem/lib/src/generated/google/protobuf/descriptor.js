...
export const FileDescriptorSet = {
    ...
    fromJSON(object) {
        return {
            file: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.file) ? object.file.map((e) => FileDescriptorProto.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a;
...
export const ExtensionRangeOptions = {
    ...
    fromPartial(object) {
        ...
        message.declaration = ((_b = object.declaration) === null || _b === void 0 ? void 0 : _b.map((e) => ExtensionRangeOptions_Declaration.fromPartial(e))) || [];
...
export const FileOptions = {
    ...
    fromPartial(object) {
        ...
        message.features = (object.features !== undefined && object.features !== null)
            ? FeatureSet.fromPartial(object.features)
            : undefined;
        message.uninterpretedOption = ((_v = object.uninterpretedOption) === null || _v === void 0 ? void 0 : _v.map((e) => UninterpretedOption.fromPartial(e))) || [];
        return message;
    },
};
...
export const MessageOptions = {
    ...
    fromPartial(object) {
        ...
        message.features = (object.features !== undefined && object.features !== null)
            ? FeatureSet.fromPartial(object.features)
            : undefined;
        message.uninterpretedOption = ((_f = object.uninterpretedOption) === null || _f === void 0 ? void 0 : _f.map((e) => UninterpretedOption.fromPartial(e))) || [];
        return message;
    },
};
...
export const FieldOptions = {
    ...
    fromPartial(object) {
        ...
        message.editionDefaults = ((_l = object.editionDefaults) === null || _l === void 0 ? void 0 : _l.map((e) => FieldOptions_EditionDefault.fromPartial(e))) || [];
        message.features = (object.features !== undefined && object.features !== null)
            ? FeatureSet.fromPartial(object.features)
            : undefined;
        message.featureSupport = (object.featureSupport !== undefined && object.featureSupport !== null)
            ...
            : undefined;
        message.uninterpretedOption = ((_m = object.uninterpretedOption) === null || _m === void 0 ? void 0 : _m.map((e) => UninterpretedOption.fromPartial(e))) || [];
        return message;
    },
};
...
export const FieldOptions_FeatureSupport = {
    ...
    create(base) {
        return FieldOptions_FeatureSupport.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseFieldOptions_FeatureSupport();
...
export const EnumOptions = {
    ...
    fromPartial(object) {
        ...
        message.features = (object.features !== undefined && object.features !== null)
            ? FeatureSet.fromPartial(object.features)
            : undefined;
        message.uninterpretedOption = ((_d = object.uninterpretedOption) === null || _d === void 0 ? void 0 : _d.map((e) => UninterpretedOption.fromPartial(e))) || [];
        return message;
    },
};
...
export const FeatureSetDefaults = {
    ...
    create(base) {
        return FeatureSetDefaults.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseFeatureSetDefaults();
        message.defaults = ((_a = object.defaults) === null || _a === void 0 ? void 0 : _a.map((e) => FeatureSetDefaults_FeatureSetEditionDefault.fromPartial(e))) || [];
...
export const FeatureSetDefaults_FeatureSetEditionDefault = {
    ...
    create(base) {
        return FeatureSetDefaults_FeatureSetEditionDefault.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseFeatureSetDefaults_FeatureSetEditionDefault();
