 ...
 */
import { Button, ButtonGroup, FAIcon, KeyBlockContainer, KeyRow, MappedKeyBlock, } from './styled.js';
...
export const Joystick = ({ xrController, pointerLocked, buttonId, mappedKeyUp, mappedKeyDown, mappedKeyLeft, mappedKeyRight, mappedKeyPressed, }) => {
    ...
    return (_jsxs(JoystickContainer, { style: {
            flexDirection: xrController.inputSource.handedness === 'left'
                ? 'row'
                : 'row-reverse',
            alignItems: 'flex-start',
        }, children: [_jsx(GamepadIcon, { buttonName: "thumbstick", handedness: xrController.inputSource.handedness }), pointerLocked ? (_jsxs(KeyBlockContainer, { "$reverse": handedness === 'right', children: [_jsxs(KeyRow, { "$reverse": handedness === 'right', children: [_jsx(MappedKeyBlock, { "$pressed": keyStates.up, style: { margin: '2px' }, children: MappedKeyDisplay[mappedKeyUp] }), _jsx(MappedKeyBlock, { "$pressed": keyStates.pressed, style: { margin: '2px' }, children: MappedKeyDisplay[mappedKeyPressed] })] }), _jsxs(KeyRow, { "$reverse": false, children: [_jsx(MappedKeyBlock, { "$pressed": keyStates.left, style: { margin: '2px' }, children: MappedKeyDisplay[mappedKeyLeft] }), _jsx(MappedKeyBlock, { "$pressed": keyStates.down, style: { margin: '2px' }, children: MappedKeyDisplay[mappedKeyDown] }), _jsx(MappedKeyBlock, { "$pressed": keyStates.right, style: { margin: '2px' }, children: MappedKeyDisplay[mappedKeyRight] })] })] })) : (_jsxs(_Fragment, { children: [_jsx(JoystickButton, { style: {
                            margin: xrController.inputSource.handedness === 'left'
                                ? '0 5px 0 -3px'
                                : '0 -3px 0 5px',
                        }, children: _jsx(JoystickInner, { ref: joystickRef, onMouseDown: handleMouseDown }) }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column' }, children: [_jsx(Button, { "$reverse": handedness === 'right', style: {
                                ...
                                }, children: "Press" }), _jsxs(ButtonGroup, { "$reverse": handedness === 'right', children: [_jsx(SmallButton, { "$reverse": xrController.inputSource.handedness !== 'left', style: {
