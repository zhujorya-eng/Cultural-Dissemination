...
export declare const PoseL: React.FC;
export declare const PoseR: React.FC;
export declare const PinchL: React.FC;
export declare const PinchR: React.FC;
...
export declare const BoxIcon: React.FC<IconProps>;
export declare const MeshIcon: React.FC<IconProps>;
export declare const PlaneIcon: React.FC<IconProps>;
export declare const IWERIcon: React.FC<IconProps>;
export {};
