 ...
 */
export function lookRotationGimbal(direction) {
 ...
 */
export function lookRotation(direction, up = { x: 0, y: 1, z: 0 }) {
    // Normalize direction
 ...
 */
export function waitForCondition(condition, timeoutMs = 5000) {
...
//# sourceMappingURL=control-math.js.map