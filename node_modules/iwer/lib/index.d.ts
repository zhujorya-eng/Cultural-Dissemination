...
export { oculusTouchV2, oculusTouchV3, metaQuestTouchPro, metaQuestTouchPlus, } from './device/configs/controller/meta.js';
...
export type { DeviceId, InputDeviceId, ControllerId, Action, DiscreteAction, DurationAction, OrientationInput, GetTransformParams, GetTransformResult, SetTransformParams, SetTransformResult, LookAtParams, LookAtResult, AnimateToParams, AnimateToResult, SetInputModeParams, SetInputModeResult, SetConnectedParams, SetConnectedResult, GetSelectValueParams, GetSelectValueResult, SetSelectValueParams, SetSelectValueResult, SelectParams, SelectResult, GamepadButtonInfo, GamepadAxisInfo, GetGamepadStateParams, GetGamepadStateResult, GamepadButtonInput, GamepadAxisInput, SetGamepadStateParams, SetGamepadStateResult, RemoteSessionStatus, AcceptSessionResult, EndSessionResult, RemoteDeviceState, SetDeviceStateParams, SetDeviceStateResult, } from './remote/index.js';
export type { Vec3, Quat, EulerRotation, InputMode, ControlMode, } from './types/state.js';
export { eulerToQuat, quatToEuler, directionTo, lookRotation, vec3ToObj, quatToObj, waitForCondition, } from './utils/control-math.js';
...
export { XRWebGLBinding, XRWebGLDepthInformation, type XRTextureType, } from './depth/XRWebGLBinding.js';
