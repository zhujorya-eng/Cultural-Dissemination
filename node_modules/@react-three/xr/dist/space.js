...
export const XRSpace = forwardRef(({ space, children }, ref) => {
    ...
    return (_jsx("group", { userData: { xrSpace: space }, xrSpace: resolvedSpace, matrixAutoUpdate: false, ref: setRef, children: resolvedSpace && _jsx(xrSpaceContext.Provider, { value: resolvedSpace, children: children }) }));
});
